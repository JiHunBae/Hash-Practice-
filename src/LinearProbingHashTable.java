...
public class LinearProbingHashTable {
	...
	public LinearProbingHashTable(int capacity, float loadFactor) { // 매개변수를 두 개 가지는 생성자
		entries = new Entry[capacity];
		this.loadFactor = loadFactor;
	}

	public LinearProbingHashTable(int capacity) { // 매개변수를 한 개 가지는 생성자
		this(capacity, 0.75F); 
	}

	public LinearProbingHashTable() { // 디폴트 생성자
		this(101);
	}
	...
	private void rehash() { // 재배열
		...
		entries = new Entry[2 * oldEntries.length + 1]; // 배열의 크기를 2배에서 1 더한 만큼 늘림
